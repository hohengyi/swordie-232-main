...
public class CharDao implements SworDao<Char> {
    ...
    public Char fromResultSet(ResultSet resultSet, String alias) {
        ...
        try {
            ...
            chr.setRb120(resultSet.getInt(alias + ".rb_120"));
            chr.setRb200(resultSet.getInt(alias + ".rb_200"));
            chr.setRb250(resultSet.getInt(alias + ".rb_250"));
            chr.setRb300(resultSet.getInt(alias + ".rb_300"));
