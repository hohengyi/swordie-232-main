...
public class Account {
    ...
    private int totalRb120;
    private int totalRb200;
    private int totalRb250;
    private int totalRb300;

    public int getTotalRb120() {
        return totalRb120;
    }

    public int getTotalRb200() {
        return totalRb200;
    }

    public int getTotalRb250() {
        return totalRb250;
    }

    public int getTotalRb300() {
        return totalRb300;
    }

//    public void incTotalRb120() {
//        totalRb120++;
//    }
//
//    public void incTotalRb200() {
//        totalRb200++;
//    }
//
//    public void incTotalRb250() {
//        totalRb250++;
//    }
//
//    public void incTotalRb300() {
//        totalRb300++;
//    }



    public void setTotalRb120(int v) { totalRb120 = v; }
    public void setTotalRb200(int v) { totalRb200 = v; }
    public void setTotalRb250(int v) { totalRb250 = v; }
    public void setTotalRb300(int v) { totalRb300 = v; }

    public int getAccountRebirthExpBonus() {
        return totalRb120 * 10
                + totalRb200 * 20
                + totalRb250 * 30
                + totalRb300 * 40;
    }

    public int getAccountRebirthDropBonus() {
        return totalRb120 * 10
                + totalRb200 * 20
                + totalRb250 * 30
                + totalRb300 * 40;
    ...
    public int getAccountRebirthMesoBonus() {
        return totalRb120 * 10
                + totalRb200 * 20
                + totalRb250 * 30
                + totalRb300 * 40;
    ...
    public int getAccountRebirthStatBonus() {
        return totalRb120 * 5
                + totalRb200 * 10
                + totalRb250 * 15
                + totalRb300 * 20;
    ...
    public void recalcAccountRebirthTotals() {
        totalRb120 = 0;
        totalRb200 = 0;
        totalRb250 = 0;
        totalRb300 = 0;
        ...
        for (Char chr : characters) {
            totalRb120 += chr.getRb120();
            totalRb200 += chr.getRb200();
            totalRb250 += chr.getRb250();
            totalRb300 += chr.getRb300();
        }
    }
